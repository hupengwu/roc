...
public class StringUtils
{
    ...
    public static String replace( String s, Map<String, Object> map )
    {
                ...
                && (end = s.indexOf( "}", start )) != -1; )
        {
            ret.append( s.substring( cursor, start ) )
                    .append( map.get( s.substring( start + 2, end ) ) );
            cursor = end + 1;
        }
    ...
    public static String replaceArgs( String source, Object... params )
    {
        ...
        for ( int count = 0; count < params.length; count++ )
        {
            ...
            while ( true )
            {
                ...
                buff.replace( startIndex, endIndex,
                        param == null ? "" : param );
            }
            startIndex = 0;
            endIndex = 0;
    ...
    public static String substringBefore( final String s,
    ...
    public static String substringAfter( final String str,
            final String separator )
    {
        if ( isEmpty( str ) )
        {

...
public class Debug {
    public void test() throws Exception {
        ...
        byte[] data1 =
            readResource("E:/apache-tomcat-6.0.18/webapps/ROOT", "log4j-1.2.16.jar:org/apache/log4j/xml/log4j.dtd");
        System.out.println(
            "E:/apache-tomcat-6.0.18/webapps/ROOT/WEB-INF/lib/log4j-1.2.16.jar包里的org/apache/log4j/xml/log4j.dtd内容如下: ");
    ...
    public static byte[] readResource(String applicationRootPath, String className) {
        ...
        if (classNames[0].endsWith(".jar")) {
            if (classNames.length == 1) {
                String jarFilePath = applicationRootPath + File.separator + "WEB-INF" + File.separator + "lib"
                    + File.separator + classNames[0];
        ...
        String classesFilePath = applicationRootPath + File.separator + "WEB-INF" + File.separator + "classes"
            + File.separator + classNames[0];

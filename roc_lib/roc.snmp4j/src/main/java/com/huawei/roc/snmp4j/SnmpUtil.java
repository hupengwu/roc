...
public class SnmpUtil
{
    ...
    public static void initSnmp() throws IOException
    {
        ...
        USM usm = new USM(
                ...
                localEngineID, 0 );
        UsmUser user = new UsmUser( new OctetString( "SNMPV3" ), AuthSHA.ID,
                new OctetString( "authPassword" ), PrivAES128.ID,
                new OctetString( "privPassword" ) );
        usm.addUser( user.getSecurityName(), user );
        messageDispatcher.addMessageProcessingModel( new MPv3( usm ) );
        // 2、创建transportMapping
        UdpAddress updAddr = (UdpAddress)GenericAddress
                .parse( "udp:10.10.112.177/161" );
    ...
    public static void snmpWalk( String oid )
    {
        try
        {
            ...
            while ( matched )
            {
                ...
                {
                    VariableBinding variableBinding = variableBindings
                            .elementAt( i );

...
public class RSAEncrypt {
     ...
     * @throws NoSuchAlgorithmException
     */
    public static void genKeyPairFile(KeyPair keyPair, String filePath, String publicKeyFileName,
        String privateKeyFileName) throws NoSuchAlgorithmException {
        // 得到私钥
        ...
        try {
            ...
            // 将密钥对写入到文件
            FileWriter pubfw = new FileWriter(filePath + "/" + publicKeyFileName + ".keystore");
            FileWriter prifw = new FileWriter(filePath + "/" + privateKeyFileName + ".keystore");

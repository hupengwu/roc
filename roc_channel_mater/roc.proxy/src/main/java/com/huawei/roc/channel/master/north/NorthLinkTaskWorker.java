 ...
 * @since 2019年12月19日
 */
public class NorthLinkTaskWorker extends LiteAsyncTaskWorker {
    /**
     * 线程函数
     */
    public void executThreadFunc() {
        ...
        try {
            ...
            socketTask.setJsonQueue(QueueManager.getNorthClientJsonRequests());
            socketTask.setSocketMapper(MapperManager.getNorthSocketContainer());

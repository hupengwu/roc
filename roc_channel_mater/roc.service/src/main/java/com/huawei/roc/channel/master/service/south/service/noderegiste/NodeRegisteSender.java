...
import com.huawei.roc.channel.master.service.south.service.noderegiste.mapper.NodeQueryer4NeedRegisteReq;
 ...
 * @since 2020年1月16日
 */
public class NodeRegisteSender {
    /**
     * 发送心态报文
     * 功能说明：如果上次发送的心跳时间超过10秒，那么就发送心跳报文
     */
    public static void sendRegiste() {
        ...
        try {
            ...
            nodeContainer.foreach(new NodeQueryer4NeedRegisteReq(System.currentTimeMillis(), 10 * 1000, nodes));
            ...
            for (Entry<String, SocketChannel> entry : nodes.entrySet()) {
                ...
                try {
                    ...
                    restVO.setResource("activate/info");
